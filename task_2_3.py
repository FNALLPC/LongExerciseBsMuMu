...
def task_2_3():
    ...
    # sig_frac   = 0.926022,  sig_mean1 = 5.27971,  sig_mean2 = 5.26646
    # sig_sigma1 = 0.0156007, sig_sigma2 = 0.0627436

    # MC-fixed parameters
    sigmc_mean1  = ROOT.RooRealVar("sigmc_mean1",  "", 5.27971)
    sigmc_mean2  = ROOT.RooRealVar("sigmc_mean2",  "", 5.26646)
    sigmc_sigma1 = ROOT.RooRealVar("sigmc_sigma1", "", 0.0156007)
    sigmc_sigma2 = ROOT.RooRealVar("sigmc_sigma2", "", 0.0627436)

    # Corrections: shift on mean, scale on sigma
