...
def task_2_5():
    ...
    # --- Read Bs->J/psi phi data ---
    fin = ROOT.TFile("root://cmseos.fnal.gov//store/user/cmsdas/2025/long_exercises/long-ex-bs-mumu/bspsiphiData.root")
    tin = fin.Get("bspsiphiData")
    ...
    # --- Read Bs->J/psi phi MC ---
    fin = ROOT.TFile("root://cmseos.fnal.gov//store/user/cmsdas/2025/long_exercises/long-ex-bs-mumu/bspsiphiMc.root")
    tin = fin.Get("bspsiphiMc")
    ...
    model  = ROOT.RooAddPdf("model", "", ROOT.RooArgList(pdf_sig, pdf_comb),
                            ROOT.RooArgList(n_sig, n_comb))
