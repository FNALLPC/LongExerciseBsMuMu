import ROOT
from common import effyield, Eff_bupsikMc, dEff_bupsikMc
...
def task_4_4():
    ...
    eff_error = effyield[cate][dEff_bupsikMc] / effyield[cate][Eff_bupsikMc] * eff  # ignore MC statistical error
    fin.Close()
